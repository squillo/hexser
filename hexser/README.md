...
```toml
[dependencies]
hexser = "0.4.3"  # Uses default features
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", default-features = false, features = ["macros"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["static-di"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["ai"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["mcp"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["async"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["visualization"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["container"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["full"] }
```
...
```toml
[dependencies]
hexser = { version = "0.4.3", default-features = false }
```

#### WASM-optimized
```toml
[dependencies]
hexser = { version = "0.4.3", default-features = false, features = ["macros", "static-di"] }
```

#### AI-enabled with async
```toml
[dependencies]
hexser = { version = "0.4.3", features = ["ai", "async", "visualization"] }
```
