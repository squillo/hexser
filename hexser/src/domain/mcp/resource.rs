...
impl Resource {
    ...
    pub fn ai_context() -> Self {
        Resource::new(
            ...
            Some(String::from("Machine-readable architecture with components, relationships, and constraints")),
    ...
    pub fn agent_pack() -> Self {
        Resource::new(
            ...
            Some(String::from("Comprehensive package with architecture, guidelines, and documentation")),
            Some(String::from("application/json")),
        )
    }
}
