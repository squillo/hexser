...
pub type AdapterError =
  crate::error::layer_error::LayerError<crate::error::layer_error::layer_markers::AdapterLayer>;
...
mod tests {
  ...
  fn test_adapter_error_with_source() {
    ...
    let err = AdapterError::new("E_HEX_200", "Database connection failed").with_source(inner);
